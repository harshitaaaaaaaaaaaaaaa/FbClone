    ...
    return (
        <div className="Main">
            ...
            <div className="Profile">
                <img src="/images/harshitaprofilepic.jpeg"alt="dp"style={{height:"50px",padding:"1rem"}}/>
                Harshita Ranjan
            </div>
            <div className="Pro">
            ...
            <div className="Profiles">
                <img src="/images/harshitaprofilepic.jpeg"alt="logo"style={{height:"105px", padding:"1rem"}}/>
                React Developer
            </div>
            <div className="Profiles">
                <img src="/images/2.jpeg"alt="logo"style={{height:"105px", padding:"1rem"}}/>
                MEAN STACK
            </div>
            <div className="Profiles">
                <img src="/images/3.jpeg"alt="logo"style={{height:"105px", padding:"1rem"}}/>
                JavaScript
            </div>
            <div className="Profiles">
                <img src="/images/4.jpeg"alt="logo"style={{height:"105px", padding:"1rem"}}/>
            ...
            <div className="MainArea">
                <div className="addStory">
                    <div className="Story">
                        <img src="/images/harshitaprofilepic.jpeg" alt="IMG" style={{height:"60px", width:"50px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="message">
                        <div className="text">
                            <div className="Post">
                                <img src="/images/harshitaprofilepic.jpeg" alt="PIC" />
                                <input type="Mind" placeholder="What's on your mind, Harshita?"/>
                            </div>
                            <div className="Call">
                                <div className="ico">
                                    <div className="icone">
                    ...
                    <div className="Posted">
                        <div className="poster">
                            <div className="Simplilearn">
                                <img src="/images/harshitaprofilepic.jpeg" alt="Img" style={{height:"50px", width:"50px", borderRadius:"50%"}}/>
                             Harshita
                                <div className="update">Posted a photo.</div>
                            </div>
                            <div className="edit"><MdMoreHoriz fontSize="1.5rem"/></div>
                        </div>
                        <div className="caption">
                         Visited Koraput Coffee and its such a nice place.Do visit guy's !!
                        </div>
                        <br></br>
                        <div className="FacebookImg">
                            <img src="/images/harshita.jpeg" alt="dp" style={{height:"auto",width:"100%"}}/>
                        </div>
                    ...
                    <div className="Posted">
                        ...
                        <div className="caption">
                         Went for a small friend meetup and had that yummy pazzta. !!
                        </div>
                        <br></br>
                        <div className="FacebookImg">
                            <img src="/images/dish.jpeg" alt="dp" style={{height:"auto",width:"100%"}}/>
                        </div>
                        <div className="Comment">
                            <div className="Like">
                                <FaRegThumbsUp color="grey"/>Like
            ...
            <div className="concise">
                <div className="Profilee">
                    <img src="/images/harshitaprofilepic.jpeg" alt="logo" style={{height:"40px",width:"50px", padding:"1rem"}}/>
                    Harshita Ranjan
                </div>
                <div className="Profilee">
